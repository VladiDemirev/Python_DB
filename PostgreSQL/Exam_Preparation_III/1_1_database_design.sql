...
CREATE TABLE IF NOT EXISTS addresses (
  ...
  CONSTRAINT ck_check_street_number_positive
  CHECK(street_number > 0),
  CONSTRAINT ck_check_zip_code_positive
  CHECK(zip_code > 0)
);
...
CREATE TABLE IF NOT EXISTS players_ranges (
  ...
  CONSTRAINT ck_check_min_players_positive
  CHECK(min_players > 0),
  CONSTRAINT ck_check_max_players_positive
  CHECK(max_players > 0)
);
...
CREATE TABLE IF NOT EXISTS board_games (
  ...
  CONSTRAINT ck_check_release_year_positive
